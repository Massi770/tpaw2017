...
function searchCity(_city)
{
    ...
    request.open ( 'GET' , 'http://api.openweathermap.org/data/2.5/weather?q='+_city+'&appid=3923ef009bbb8283f9dd71e2f95d668b' +'&units=metric' , true );
    request.onload = function () {
		...
		if ( request.status >= 200 && request.status < 400 ) {
			...
			//var icon = "https://demo.bilelz.fr/owmap/?q=paris&appid=3923ef009bbb8283f9dd71e2f95d668b"+respObject.weather[0].icon+".png";
